...
class Batch(object):
    ...
    def __init__(self, data=None, device=None, is_test=False):
        ...
        if data is not None:
            ...
            pre_zs = [x[6] for x in data]
            pre_z_segs = [x[7] for x in data]
...
class DataIterator(object):
    ...
    def preprocess(self, ex, is_test):
        ...
        if(is_test):
            return src, tgt, segs, clss, src_sent_labels, id_, z, z_segs, src_txt, tgt_txt
        else:
            return src, tgt, segs, clss, src_sent_labels, id_, z, z_segs
